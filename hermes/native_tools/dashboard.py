...
<main class="shell">
  ...
  <section id="cabinet" hidden>
    ...
    <section id="view-memory" class="view" hidden>
      ...
      <section class="section status-section"><div class="section-head"><div><p class="eyebrow">СИСТЕМА</p><h2>Статус</h2></div></div><div id="system" class="status-list"></div></section>
    </section>
  </section>
</main>

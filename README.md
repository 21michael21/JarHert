...
- `preference_pairs`: 40 явных пар «плохой ответ → исправленный хороший ответ».

Это 300 SFT-примеров и 40 отдельных preference-пар. `JSON extractor`, tool calls,
...
Когда накопятся целевые 340 согласованных примеров, собери локальные файлы:
